...
<Note>
  Chris should add a short silent walkthrough/no-speech video or GIF showing navigation in Settings and where to find organization-wide and selected ad account ad defaults.
</Note>